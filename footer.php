...
?>
  ...
  <footer id="footer" class="<?php if(@$forclient_options['sections-footer-background-type'] == 1) echo @$forclient_options['sections-footer-background'] . ' ';?><?php if(@$forclient_options['sections-footer-color-type'] == 1) echo @$forclient_options['sections-footer-color'];?>" style="height:100vh; background-color: yellow">
