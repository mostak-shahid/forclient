...
?>
<section id="page" class="page-content <?php if(@$forclient_options['sections-content-background-type'] == 1) echo @$forclient_options['sections-content-background'] . ' ';?><?php if(@$forclient_options['sections-content-color-type'] == 1) echo @$forclient_options['sections-content-color'];?> <?php echo $class ?>" <?php if(@$background_img) echo 'style="background-image:url('.$background_img.')"'; ?>>
